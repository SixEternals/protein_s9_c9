...
echo "[BL5-v4-PAM-only-control] Starting formal 2-GPU training..."
echo "Config: configs/bl5_v4_pam_only_control.yaml"
echo "GPUs: $CUDA_VISIBLE_DEVICES"
echo "Output: results/bl5_v4_pam_only_control"
