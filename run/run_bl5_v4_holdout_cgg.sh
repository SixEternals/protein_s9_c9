#!/usr/bin/env bash
# Launch BL5-v4 PAM or NoPAM holdout-CGG run on two GPUs.
#
# Usage:
#   bash run/run_bl5_v4_holdout_cgg.sh pam
...
if [ "$MODE" = "pam" ]; then
  CONFIG="configs/bl5_v4_pam_holdout_cgg.yaml"
  OUTPUT_DIR="results/bl5_v4_pam_holdout_cgg"
  TMUX_NAME="${TMUX_NAME:-bl5_pam_holdout_cgg}"
elif [ "$MODE" = "nopam" ]; then
  CONFIG="configs/bl5_v4_nopam_holdout_cgg.yaml"
  OUTPUT_DIR="results/bl5_v4_nopam_holdout_cgg"
  TMUX_NAME="${TMUX_NAME:-bl5_nopam_holdout_cgg}"
else
...
echo "========================================"
echo " BL5 holdout-CGG 2-GPU launcher"
echo "========================================"
echo "[INFO] Mode:    $MODE"
