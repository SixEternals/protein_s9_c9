#!/usr/bin/env bash
# Launch BL5-v4 PAM or NoPAM holdout-GAG run on two GPUs.
#
# Usage:
#   bash run/run_bl5_v4_holdout_gag.sh pam
...
if [ "$MODE" = "pam" ]; then
  CONFIG="configs/bl5_v4_pam_holdout_gag.yaml"
  OUTPUT_DIR="results/bl5_v4_pam_holdout_gag"
  TMUX_NAME="${TMUX_NAME:-bl5_pam_holdout_gag}"
elif [ "$MODE" = "nopam" ]; then
  CONFIG="configs/bl5_v4_nopam_holdout_gag.yaml"
  OUTPUT_DIR="results/bl5_v4_nopam_holdout_gag"
  TMUX_NAME="${TMUX_NAME:-bl5_nopam_holdout_gag}"
else
...
echo "========================================"
echo " BL5 holdout-GAG 2-GPU launcher"
echo "========================================"
echo "[INFO] Mode:    $MODE"
