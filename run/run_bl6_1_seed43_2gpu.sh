#!/usr/bin/env bash
# Launch BL6-1-PAM-Gated-Fusion seed43 multi-seed repeat on two GPUs.
#
# Usage:
#   bash run/run_bl6_1_seed43_2gpu.sh
#   bash run/run_bl6_1_seed43_2gpu.sh configs/bl6_1_pam_gated_fusion_seed43.yaml
#   bash run/run_bl6_1_seed43_2gpu.sh configs/bl6_1_pam_gated_fusion_seed43.yaml results/bl6_1_pam_gated_fusion_seed43
#
# Environment overrides:
#   PYTHON_BIN=/path/to/python
#   CUDA_VISIBLE_DEVICES=0,1
#   MASTER_PORT=29543
#   TMUX_NAME=bl6_1_seed43
#   FOREGROUND=1
...
CONFIG="${1:-${CONFIG:-configs/bl6_1_pam_gated_fusion_seed43.yaml}}"
OUTPUT_DIR="${2:-${OUTPUT_DIR:-results/bl6_1_pam_gated_fusion_seed43}}"

PYTHON_BIN="${PYTHON_BIN:-/data/zwf/conda/envs/reborn_seed/bin/python}"
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1}"
MASTER_PORT="${MASTER_PORT:-29543}"
TMUX_NAME="${TMUX_NAME:-bl6_1_seed43}"
...
echo "========================================"
echo " BL6-1 seed43 2-GPU launcher"
echo "========================================"
...
if tmux has-session -t "$TMUX_NAME" 2>/dev/null; then
  ...
  echo "        Or choose another name: TMUX_NAME=bl6_1_seed43b bash $0 $CONFIG ${OUTPUT_DIR:-}" >&2
  exit 1
fi
